...
public class FileTrans {
    ...
    public static String trans(final String txtFilename) throws IOException {
        /*
         * comment.
         */
        Reader reader = null;
        final String outfilename = txtFilename.substring(0,txtFilename.lastIndexOf('.')) + "temp" + ".txt";
        try {
